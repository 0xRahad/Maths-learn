package com.devsectech.math.utils;
...
import com.devsectech.math.data.MainData;
import com.devsectech.math.model.DualScoreModel;
import com.devsectech.math.model.HistoryModel;
import com.devsectech.math.model.LearnModel;
import com.devsectech.math.model.MainModel;
import com.devsectech.math.model.ReviewTestListModel;
import com.devsectech.math.model.ReviewTestModel;
import com.devsectech.math.model.SubModel;
import com.devsectech.math.ui.FindMissingActivity;
import com.devsectech.math.ui.InputActivity;
import com.devsectech.math.ui.QuizActivity;
import com.devsectech.math.ui.TrueFalseActivity;
...
//            intent.setData(Uri.parse("mailto:" + activity.getResources().getString(R.string.feedback_mail))); // only email apps should handle this
//            intent.putExtra(Intent.EXTRA_EMAIL, activity.getResources().getString(R.string.feedback_mail));
//
//
...
//        }
    ...
    //    fun sendFeedback(feedback: String, activity: Activity) {
//
//        val str: String
//        try {
//            str = activity.packageManager.getPackageInfo(activity.packageName, 0).versionName
//            val i = Intent(Intent.ACTION_SEND)
//            i.type = "message/rfc822"
//            i.putExtra(Intent.EXTRA_EMAIL, arrayOf(activity.resources.getString(R.string.mail)))
//            i.putExtra(Intent.EXTRA_SUBJECT, "Feedback for All Maths Formulas")
